...
if("TRUE" STREQUAL "TRUE")
  set(data_handle_SOURCE_PREFIX /home/marcel/inz_ws/src/dataHandle)
  set(data_handle_DEVEL_PREFIX /home/marcel/inz_ws/devel)
  ...
  set(data_handle_INSTALL_PREFIX /home/marcel/inz_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'data_handle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marcel/inz_ws/src/dataHandle/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT data_handle_NUM_DUMMY_TARGETS)
      set(data_handle_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::data_handle::wrapped-linker-option${data_handle_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR data_handle_NUM_DUMMY_TARGETS "${data_handle_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::data_handle::wrapped-linker-option${data_handle_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND data_handle_LIBRARIES "${interface_target_name}")
